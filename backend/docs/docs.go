...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/AuthLoginResponseDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/WechatminiappLoginRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/WechatminiappLoginResponseDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/WechatminiappErrorDoc"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "ListResponseDoc": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/RegistrationcodeListResponse"
                },
                "errorMsg": {
                    "type": "string"
                }
        ...
        "MiniAppAuthResponse": {
            ...
            "properties": {
                ...
                "user": {
                    "$ref": "#/definitions/MiniAppUserResponse"
                }
            }
        },
        "MiniAppPresetsResponse": {
            "type": "object",
            "required": [
                "chatModel",
                "imageModel"
        ...
        "OperationRequest": {
            ...
            "properties": {
                ...
                "list": {
                    "$ref": "#/definitions/ListDraftRequest"
                },
                "task": {
                    "$ref": "#/definitions/TaskDraftRequest"
                }
            }
        },
        ...
        "SnapshotResponse": {
            ...
            "properties": {
                "lists": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/MiniapptodoListResponse"
                    }
                },
                "tasks": {
                    "type": "array",
        ...
        "WechatminiappLoginResponse": {
            ...
            "properties": {
                "auth": {
                    "$ref": "#/definitions/MiniAppAuthResponse"
                },
                "created": {
                    "type": "boolean"
                },
                "presets": {
                    "$ref": "#/definitions/MiniAppPresetsResponse"
                }
            }
        },
        "WechatminiappLoginResponseDoc": {
            "type": "object",
            "required": [
                "data",
                "errorMsg"
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/WechatminiappLoginResponse"
                },
                "errorMsg": {
                    "type": "string"
                }
